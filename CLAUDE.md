...
deliberately extends the
existing `voice-whisper`-specific seam in core's `ui/src/lib/api.ts`; the generic
transcription-capability contract is a follow-up filed when that issue closes.
